...
export declare function useAxisTicksProps(inProps: ChartsXAxisProps): {
  ...
  defaultizedProps: {
    ...
    valueFormatter?: (<TScaleName extends keyof import("../internals/index.js").AxisScaleConfig>(value: any, context: import("@mui/x-charts/models").AxisValueFormatterContext<TScaleName>) => string) | undefined;
    hideTooltip?: boolean;
