 ...
 */
export declare function getSeriesHighlightedDataIndex<SeriesType extends SeriesTypeWithBatchRendering>(scope: Partial<HighlightScope<SeriesType>> | null, item: HighlightItemIdentifier<SeriesType> | null, seriesId: SeriesId): number | null | undefined;
/**
 ...
 */
export declare function getSeriesUnfadedDataIndex<SeriesType extends SeriesTypeWithBatchRendering>(scope: Partial<HighlightScope<SeriesType>> | null, item: HighlightItemIdentifier<SeriesType> | null, seriesId: SeriesId): number | null | undefined;
export {};