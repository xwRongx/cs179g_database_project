...
export function NotRendered(_props) {
  throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X Charts: Failed assertion - this component should not be rendered. ' + 'This is an internal component used for styling purposes only. ' + 'If you see this error, there may be a configuration issue with styled components.' : _formatErrorMessage(31));
}