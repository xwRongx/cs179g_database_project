...
const rotate = async (pointerManager, options, advanceTimers) => {
  ...
  if (!target) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Target element is required for rotate gesture' : (0, _formatErrorMessage2.default)(175));
  }
  ...
  if (pointersArray.length < 2) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Rotate gesture requires at least 2 pointers' : (0, _formatErrorMessage2.default)(176));
  }
