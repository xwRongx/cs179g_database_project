...
export const pinch = async (pointerManager, options, advanceTimers) => {
  ...
  if (!target) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Target element is required for pinch gesture' : _formatErrorMessage(172));
  }
  ...
  if (pointersArray.length < 2) {
    throw new Error(process.env.NODE_ENV !== "production" ? 'MUI X: Pinch gesture requires at least 2 pointers' : _formatErrorMessage(173));
  }
