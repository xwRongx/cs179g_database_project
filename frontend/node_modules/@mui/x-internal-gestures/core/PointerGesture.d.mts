...
import { Gesture, GestureEventData, GestureOptions, type BaseGestureOptions } from "./Gesture.mjs";
import type { KeyboardManager } from "./KeyboardManager.mjs";
import { PointerData, PointerManager } from "./PointerManager.mjs";
...
export declare abstract class PointerGesture<GestureName extends string> extends Gesture<GestureName> {
  ...
  protected getBaseConfig(): {
    requiredKeys: import("./KeyboardManager.mjs").KeyboardKey[];
    minPointers: number;
    maxPointers: number;
  };
